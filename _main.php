...
<head>
	...
	<link href="<?php echo $config->urls->templates; ?>styles/style.css" media="screen, projector, print" rel="stylesheet" type="text/css" />
	<script src="<?php echo $config->urls->templates; ?>scripts/vendor/custom.modernizr.js"></script>
</head>
<body class='<?php echo "template-$page->template section-{$page->rootParent->name} page-$page"; ?>'>
	...
	<script src="<?php echo $config->urls->templates; ?>scripts/vendor/jquery.js"></script>
	<script src="<?php echo $config->urls->templates; ?>scripts/foundation/foundation.min.js"></script>
